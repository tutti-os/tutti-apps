...
- Verification:
  ...
  - `pnpm --filter @tutti-apps/daily-tech-radar test` passed.
  - `pnpm --filter @tutti-apps/daily-tech-radar i18n:check` passed.
  - `pnpm package:tutti --app daily-tech-radar` passed.
...
- Verification:
  - `pnpm --filter @tutti-apps/daily-tech-radar test -- app-shell.test.tsx` passed.
  - `pnpm --filter @tutti-apps/daily-tech-radar typecheck` passed.
  - `pnpm --filter @tutti-apps/daily-tech-radar build` passed.
